...
int main(){
	...
	Mandelbrot2 m1("m2.ppm",512,512,(double)-2,(double)1,(double)1,(double)-1,1024, 4);
	Timer mand1,mand2;
	...
	for(int i=0;i<5;++i)
	{
		std::cout << mand1.timeTask<Mandelbrot2, &Mandelbrot2::generateParallel>(new Mandelbrot2("m1.ppm", 512, 512,(double)-2,(double)1,(double)1,(double)-1, 1024, 4)) << std::endl;
	}
